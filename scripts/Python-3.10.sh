...
NAME=Python
IDENTIFIER="org.python.pkg.python310"
VERSION=3.10.16
VERMAJ="${VERSION:0:4}"
VEREXTRA=""
VERNAME=${NAME}-${VERSION}${VEREXTRA}
CHKSUM=bfb249609990220491a1b92850a07135ed0831e41738cf681d63cf01b2a8fbd1
...
# Don't make default Python version.
rm -f \
   $STAGING/Library/Frameworks/Python.framework/Headers \
   $STAGING/Library/Frameworks/Python.framework/Python \
   $STAGING/Library/Frameworks/Python.framework/Resources \
   $STAGING/Library/Frameworks/Python.framework/Versions/Current \
   $STAGING/usr/local/bin/idle3 \
   $STAGING/usr/local/bin/pydoc3 \
   $STAGING/usr/local/bin/python3 \
   $STAGING/usr/local/bin/python3-config
